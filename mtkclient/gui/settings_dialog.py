...
class SettingsDialog(QDialog):
    ...
    def create_auth_tab(self):
        ...
        cert_browse.clicked.connect(lambda: self.browse_file(self.cert_input, "Certificate Files (*.pem *.cert);;All Files (*)"))
    ...
    def create_exploit_tab(self):
        ...
        preloader_browse.clicked.connect(lambda: self.browse_file(self.preloader_input, "Preloader Files (*.bin);;All Files (*)"))
